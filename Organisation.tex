...
\begin{document}
	...
	\begin{center}
		...
		\addcontentsline{toc}{section}{Unternehmenssteckbrief}
	\end{center}  
	\begin{flushright}
		\includegraphics[width=2cm]{./images/dl-telekom-logo.jpg} % dl-telekom-logo oben rechts
	\end{flushright}
	\vspace*{-2cm} 
	...
	\begin{flushleft}
		\begin{minipage}{5cm}
			...
			\captionof{figure}{Schwungrad zur Vision „Leading Digital Telco“ \autocite{ag_strategie_2024}}
